...
const Cart = ({activePanel , handlClosePanel, cart , removeItem  , quantityIncrement , quantityDecrease ,subTotal , totalItem , shipingFee ,totalSummary }) => {
  return (
    ...
    ${activePanel === 'Cart' ? 'translate-x-0' : 'translate-x-full'} `}>
      ...
      <footer className="px-5 py-2 bg-white border-t shrink-0">
        ...
        <button className={`w-full  py-3 rounded-xl  flex items-center justify-center gap-2 ${cart.length === 0 ?   "bg-gray-200" : 
...
//     return (<>
//         <aside className="fixed top-0 right-0 h-screen w-full sm:w-[420px] bg-gradient-to-b from-gray-50 to-gray-100 z-50 shadow-2xl flex flex-col transform translate-x-ful">
...
//         {/* ACTIONS */}
//         <button className="w-full mt-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold py-4 rounded-xl hover:shadow-lg transition flex items-center justify-center gap-2">
//           Proceed to Checkout
//           <i className="ri-arrow-right-line" />
//         </button>

//         <p className="mt-3 text-xs text-gray-500 text-center flex items-center justify-center gap-2">
