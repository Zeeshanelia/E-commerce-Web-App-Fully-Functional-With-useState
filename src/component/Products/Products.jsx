...
const Products = () => {
    ...
    const renderingProducts = ProductsList.map((item) => {
            ...
            <div>
                ...
                <div className=" w-full border-1 border-gray-200 rounded-lg p-1 hover:shadow-lg hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="flex justify-between items-center mb-1 px-2">
                        ...
                        <span className="bg-purple-400 font-bold p-2 py-1 text-black text-xs rounded"> sale </span>
                    </div>
    ...
    return (<>
        <section className="max-w-[79rem] mx-auto px-10 mt-10 mb-10">
